...
Popup is served as an alternative to [PopClip](https://www.popclip.app/).
...
| Path | Description |
|------|-------------|
| `Casks/popup.rb` | Homebrew cask for installing Popup.app |
...
1. Install Popup.app with Homebrew:
```bash
